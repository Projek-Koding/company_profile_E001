...
@section('content')
    ...
    <div class="flex justify-center font-['Poppins']">
        <div class="px-5 py-44 flex-col gap-5 w-full max-w-5xl flex items-center">

            {{-- about us --}}
            <div class="self-stretch text-[#064dac] text-2xl font-bold">Tentang Kami</div>
            ...
            <div class="flex-col gap-4  flex items-center">
                <div class="self-stretch p-5 bg-white rounded-lg drop-shadow flex-col justify-start items-start gap-3 flex">
                    <div class="self-stretch text-[#414141] text-lg font-bold  leading-7">Sejarah
                        Organisasi Daerah Muhammadiyah Kab. Pinrang</div>
                    ...
                    <div class="flex-col gap-2.5 flex text-[#7b7b7b] text-sm">
                        ...
                        <div class="flex-col gap-1 flex">
                            ...
                            <div class="text-justify font-normal ">
                                ...
                                tersebut
                                dibuat oleh Admin yang merupakan anggota organisasi Daerah Muhammadiyah Kab. Pinrang.
                                Pengumuman
                                yang dibuat adalah pengumuman tentang administrasi sehingga diharapkan anggota organisasi
                                mendapatkan informasi administrasi dengan efektif dan efisien.
                            </div>
                        </div>
                        ...
                        <div class="flex-col gap-1 flex ">
                            ...
                            <div class="text-justify font-normal ">
                                ...
                                dibuat oleh Admin yang merupakan anggota organisasi Daerah Muhammadiyah Kab. Pinrang. Berita
                                yang dibuat adalah Berita tentang ha-hal yang berkaitan dengan Organisasi daerah kabupaten
                                Pinrang. Tujuan Berita ini adalah untuk memberitakan secara up-to-date kegiatan/acara atau
                                peristiwa yang terjadi dalam lingkup organisasi.
                            </div>
                        </div>
                    </div>
