...
@section('content')
	...
	<div
		...
		<div class="mb-6 flex w-full flex-col justify-center pl-40 md:mb-0 md:w-1/2">
			...
			<a href="#"
				class="mx-auto w-fit bg-white px-6 py-2 font-semibold text-primary duration-300 hover:scale-105 hover:bg-gray-300 md:mx-0">Pelajari
				Lebih Lanjut</a>
		</div>
	...
	<div class="flex min-h-screen w-full flex-wrap items-center justify-center bg-white py-8 max-md:flex-col">
		...
		<div class="flex w-1/4 justify-end p-4 max-md:w-full max-md:justify-center md:w-1/4">
		...
		<div class="flex w-3/4 justify-start p-4 max-md:w-full max-md:justify-center md:w-2/4">
			<p class="text-left text-xl font-medium text-primary max-md:text-center">
	...
	<div class="w-full bg-primary py-16 text-white">
		<div class="container mx-auto px-6">
			...
			<div class="grid grid-cols-1 gap-8 md:grid-cols-3">
				<!-- Card Profil 1 -->
				<div
					class="group relative transform border-l-4 border-white bg-blue-700 p-8 shadow-lg transition-all duration-300 hover:scale-105 hover:border-yellow-400 hover:shadow-2xl">
			...
			<div class="mt-12 flex justify-center">
				<a href="#"
					class="mx-auto w-fit bg-white px-6 py-2 font-semibold text-primary duration-300 hover:scale-105 hover:bg-gray-300 md:mx-0">
					Pelajari Lebih Lanjut
				</a>
			</div>
		</div>
	...
	@php
		...
		$beritaList = [
		    [
		        ...
		        'deskripsi' =>
		            'Lorem ipsum dolor sit, amet consectetur adipisicing elit. Quod officia illum maiores quam qui architecto molestiae, non odio. Necessitatibus ut nobis, deleniti odit sapiente aspernatur velit at magnam iste ea.',
		        'gambar' =>
	...
	<!-- Section Berita -->
	<div class="mt-2 min-h-screen w-full bg-primary py-16 text-white">
		<div class="container mx-auto px-6">
			<!-- Judul Section Berita -->
			<div class="mb-12 text-center">
				<h2 class="mb-4 text-4xl font-extrabold uppercase tracking-wider">Berita Terbaru</h2>
			...
			<div class="grid grid-cols-1 gap-8 md:grid-cols-3">
				...
				@foreach ($beritaList as $berita)
					<div
						class="group relative transform bg-white text-primary shadow-lg transition-all duration-300 hover:scale-105 hover:shadow-2xl">
						<img src="{{ $berita['gambar'] }}" alt="{{ $berita['judul'] }}" class="h-48 w-full object-cover">
						<div class="p-6">
							<h3 class="mb-2 text-xl font-bold transition-colors duration-300 group-hover:text-yellow-400">
								{{ $berita['judul'] }}
							</h3>
							<p class="text-gray-700 duration-300 group-hover:text-gray-800">
								{{ $berita['deskripsi'] }}
							</p>
						</div>
						<a href="{{ url('/berita/detail/' . $berita['id']) }}"
							class="absolute bottom-4 right-4 text-sm font-semibold text-primary transition-colors duration-300 group-hover:text-yellow-400">
							Baca Selengkapnya →
						</a>
					</div>
				@endforeach
	...
	<div class="bg-primary py-12 text-white">
		<div class="container mx-auto flex flex-col items-center">
			...
			<p class="mb-6 max-w-xl text-center">
				Jika Anda memiliki pertanyaan atau memerlukan informasi lebih lanjut, jangan ragu untuk menghubungi kami melalui
				kontak yang tersedia.
			</p>
			<a href="#" class="rounded-md bg-white px-6 py-2 text-primary duration-300 hover:bg-gray-200">Hubungi
				Sekarang</a>
		</div>
	</div> --}}
@endsection
